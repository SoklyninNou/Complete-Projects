...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        HyponymsGraph HG = new HyponymsGraph(SYNSETS_FILE_SUBSET, HYPONYMS_FILE_SUBSET);

        hns.startUp();
        hns.register("history", new HistoryHandler(ngm));
        ngm.register("historytext", new HistoryTextHandler(ngm));
